...
# Mentor Frontend - Aplicación de calculadora

![Vista previa del diseño para el desafío de codificación de la aplicación Calculadora](./design/desktop-preview.jpg)
...
**Para realizar este desafío, necesitas un buen conocimiento de HTML, CSS y JavaScript.**

## El reto

Su desafío es desarrollar esta aplicación de calculadora y hacer que se parezca lo más posible al diseño.
...
- Vea cómo el tamaño de los elementos se ajusta según el tamaño de la pantalla de su dispositivo.
- Realizar operaciones matemáticas como suma, resta, multiplicación y división.
- Ajusta el tema de color según sus preferencias.
...
1. Comparte tu página de solución en **#fin
Canal ished-projects** de la [comunidad](https://www.frontendmentor.io/community).
